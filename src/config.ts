...
export const siteConfig: SiteConfig = {
  ...
  description: "Machine Learning Engineer | MSCS @ Georgia Tech",
  // [CONFIG:SITE_AUTHOR]
  author: "Zac Cardwell",
  ...
  navigation: {
    ...
    pages: [
      ...
      { title: "GitHub", url: "https://github.com/Zac-Cardwell" },
      { title: "Linkedin", url: "https://www.linkedin.com/in/zac-cardwell/" }
    ],
    // [CONFIG:NAVIGATION_SOCIAL]
    social: [
      {
        title: "GitHub",
        url: "https://github.com/Zac-Cardwell",
        icon: "github",
      },
      {
        title: "Linkedin",
        url: "https://www.linkedin.com/in/zac-cardwell/",
        icon: "fa-linkedin",
      },
    ],
  },
